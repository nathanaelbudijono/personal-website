...
During my internship at the Ministry of Finance, I had the privilege of contributing to project. As part of the _Lembaga National Single Window_, I took on the responsibility of developing a reporting application with fellow teamates [Dzulfikar](https://github.com/dzulfikarfath02), [Riky](https://github.com/rikyindrasaktii), and [Alka](https://github.com/alfathahuga). Leveraging the power of NextJs, TypeScript, Prisma, TailwindCSS, and PostgreSQL.
